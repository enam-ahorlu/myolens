...
**Split.** Trained on **37 subjects**. Subjects **10, 13 and 22** were held out entirely — one that the thesis identifies as among the hardest, one among the easiest, one middling — and never contributed to training, validation or model selection. Within the 37, six subjects (5, 16, 20, 29, 33, 39) formed the deep model's early-stopping validation set.
